...
def get_deepprime_clinvar_datasheets() -> None:
    """
...
def get_pridict2_library_diverse_datasheets(original_data_path: str) -> None:
    """
...
def deepprime_clinvar_to_std(data: pd.DataFrame, cell_line: str, pe_system: str, model: str = None) -> None:
    '''
...
def pridict2_library_diverse_to_std(data: pd.DataFrame, cell_line: str, pe_system: str, model: str = 'pd2') -> pd.DataFrame:
    '''
