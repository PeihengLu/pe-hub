...
\begin{enumerate}
    ...
    The main library \nolinkurl{library1} uses a self-targeting lentiviral reporter format in HEK293T cells also similar to Kim et al. 2021. The pegRNAs were delivered by lentiviral transduction and PE2 was delivered by plasmid transfection.
    ...
    The library-diverse dataset extends the PRIDICT1 approach with a broader range of edit types, screened in HEK293T, K562, and K562 MLH1$^{-/-}$ (mismatch repair-deficient) cell lines using the same self-targeting lentiviral reporter system, with the same delivery method as PRIDICT1.
