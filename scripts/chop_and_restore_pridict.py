...
def chop_pridict_data():
    ...
    pridict_data = pd.read_csv(DATA_ROOT / 'pridict1-org' / 'pridict1-org.csv')
    ...
    part1.to_csv(DATA_ROOT / 'pridict1-org' / 'pridict1_part1.csv', index=False)
    part2.to_csv(DATA_ROOT / 'pridict1-org' / 'pridict1_part2.csv', index=False)
    part3.to_csv(DATA_ROOT / 'pridict1-org' / 'pridict1_part3.csv', index=False)
...
def restore_pridict_data():
    ...
    part1 = pd.read_csv(DATA_ROOT / 'pridict1-org' / 'pridict1_part1.csv')
    part2 = pd.read_csv(DATA_ROOT / 'pridict1-org' / 'pridict1_part2.csv')
    part3 = pd.read_csv(DATA_ROOT / 'pridict1-org' / 'pridict1_part3.csv')
    ...
    restored_data.to_csv(DATA_ROOT / 'pridict1-org' / 'pridict1-org.csv', index=False)
