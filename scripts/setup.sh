...
echo ""
echo "Next steps:"
echo "1. Run PE Database: cd services/pe-db && uvicorn pe_db.main:app --reload --port 8000"
echo "2. Run PE Ensemble: cd services/pe-ensemble && PE_DB_URL=http://localhost:8000 uvicorn pe_ensemble.main:app --reload --port 8001"
